...
import tdrLogo from "../assets/tdr-logo.png";
      ...
      >
        <div className="h-full px-3 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <div className="flex items-center justify-center ps-2.5">
            <Link to="/">
              <img src={tdrLogo} className="h-20 me-3 sm:h-20" alt="TDR Logo" />
            </Link>
          </div>
          <ul className="space-y-2 font-medium mt-4">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Tractos</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <Link
                to="/mantenimientos"
                className={`flex items-center p-2 rounded-lg group ${
                  location.pathname === "/mantenimientos"
                    ? "bg-gray-200 text-yellow-400"
                    : "text-gray-900 hover:bg-gray-100"
                }`}
              >
